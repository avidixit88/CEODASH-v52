...
from engines.sponsor_evidence_engine import sponsor_evidence_table
        ...
        if clinical is not None:
            ...
            if sponsor_evidence is not None:
                ...
                if not evidence_df.empty:
                    with st.expander("Sponsor evidence layer: recent dynamic sponsor communications"):
                    ...
                    if unmapped:
                        ...
                        st.caption("Sponsor evidence layer ran, but no recent sponsor communication matched clinical result, endpoint, or data-timing language in this run.")
